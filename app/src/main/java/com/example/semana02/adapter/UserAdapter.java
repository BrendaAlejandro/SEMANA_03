...
public class UserAdapter extends ArrayAdapter<User>  {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        txtName.setText(String.valueOf(objUser.getName()));

        TextView txtEmail = row.findViewById(R.id.idItemEmail);
        txtEmail.setText(String.valueOf(objUser.getEmail()));

        TextView txtPhone = row.findViewById(R.id.idItemPhone);
        txtPhone.setText(String.valueOf(objUser.getPhone()));

        TextView txtWebsite = row.findViewById(R.id.idItemWebsite);
        txtWebsite.setText(String.valueOf(objUser.getWebsite()));
